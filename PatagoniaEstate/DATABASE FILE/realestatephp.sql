...
--The table for the 'about' section
CREATE TABLE `about` (
  `id` int(10) NOT NULL,
...
--populating the table 'admin' with sample data
...
--populating the table 'city' with sample data
...
--creating the table for 'contact'
...
--populating the table 'contact' with sample data
INSERT INTO `contact` (`cid`, `name`, `email`, `phone`, `subject`, `message`) VALUES
(7, 'codeastro', 'asda@asd.com', '8888885454', 'codeastro.com', 'asdasdasd');

--creating the table for 'feedback'
...
--populating the table 'feedback' with sample data
...
--creating the table for 'property' with all the necessary fields
...
--populating the table 'property' with sample data in order to have some initial properties

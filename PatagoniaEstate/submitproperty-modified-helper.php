...
class PropertyManager
{
    ...
    private function uploadImages($file, $destination)
    {
    ...
    {
        foreach (['aimage', 'aimage1', 'aimage2', 'aimage3', 'aimage4', 'fimage', 'fimage1', 'fimage2'] as $image) {
            $this->uploadImages($property[$image], "admin/property/");
        }
        ...
        values('$property[title]','$property[content]','$property[ptype]','$property[bhk]','$property[stype]','$property[bed]','$property[bath]','$property[balc]','$property[kitc]','$property[hall]','$property[floor]','$property[asize]','$property[price]',
        '$property[loc]','$property[city]','$property[state]','$property[feature]','$property[aimage]','$property[aimage1]','$property[aimage2]','$property[aimage3]','$property[aimage4]','$property[uid]','$property[status]','$property[fimage]','$property[fimage1]','$property[fimage2]','$property[totalfl]', '$property[isFeatured]')";
...
$propertyManager = new PropertyManager($con);

if(isset($_POST['add']))
{
    $propertyManager->addProperty($_POST);
}
